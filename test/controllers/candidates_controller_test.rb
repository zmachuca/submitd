...
class CandidatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create candidate" do
    assert_difference('Candidate.count') do
      post candidates_url, params: { candidate: { date_submitted: @candidate.date_submitted, name: @candidate.name } }
    end
  ...
  test "should update candidate" do
    patch candidate_url(@candidate), params: { candidate: { date_submitted: @candidate.date_submitted, name: @candidate.name } }
